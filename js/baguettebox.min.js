var baguetteBox = function() {
    function t(t, i) {
        L.transforms = f(), L.svg = p(), e(), D = document.querySelectorAll(t), [].forEach.call(D, function(t) {
            ...
            var n = S.length;
            S.push(e), S[n].options = i, [].forEach.call(S[n], function(t, e) {
                h(t, "click", function(t) {
                    t.preventDefault ? t.preventDefault() : t.returnValue = !1, o(n), a(e)
                })
            })
        })
    }
    ...
    function o(t) {
        if (A !== t) {
            for (A = t, i(S[t].options); k.firstChild;) k.removeChild(k.firstChild);
            X.length = 0;
    ...
    function r(e, n) {
        ...
        if ("undefined" != typeof t) {
            ...
            imageElement = S[A][e], imageCaption = imageElement.getAttribute("data-caption") || imageElement.title, imageSrc = l(imageElement);
            var i = y("figure"),
                o = y("img"),
                a = y("figcaption");
            t.appendChild(i), i.innerHTML = '<div class="spinner"><div class="double-bounce1"></div><div class="double-bounce2"></div></div>', o.onload = function() {
                var t = document.querySelector("#baguette-img-" + e + " .spinner");
                i.removeChild(t), !I.async && n && n()
            }, o.setAttribute("src", imageSrc), i.appendChild(o), I.captions && imageCaption && (a.innerHTML = imageCaption, i.appendChild(a)), I.async && n && n()
        }
    }
